...
int main() {
    ...
    string root_path = "~/fork/opencv/samples/cpp/example_cmake/";
    string file_path = root_path + "images/";


    Mat imageL = imread(file_path + "1.jpg", 1);    //右图
    Mat imageR = imread(file_path + "2.jpg", 1);    //左图
...
//    imshow("p1", imageR);
    ...
    cv::imwrite(root_path + "result/result.png", imageOutput);
